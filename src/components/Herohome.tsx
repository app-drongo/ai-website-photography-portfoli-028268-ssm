        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
              Discover exceptional luxury homes in
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Experience unparalleled service with Amanda Foster Luxury Homes. From exclusive estates to prime investment opportunities, we deliver exceptional results in Beverly Hills' most prestigious neighborhoods.
            </p>
          ...
          <div className="relative">
            ...
            <div className="absolute -right-6 -top-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              <p className="text-xs text-muted-foreground">Recent Sale</p>
              <p className="text-sm">
                <span className="font-semibold">$12.5M</span> Beverly Hills
              </p>
            </div>
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold">5.0</span> stars
              </p>
            </div>
          </div>
        </div>
