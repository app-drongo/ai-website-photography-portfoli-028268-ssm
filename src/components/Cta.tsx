...
export default function Cta() {
  const stats = [
    { value: "$2.5B+", label: "Sales Volume", icon: Users },
    { value: "98%", label: "Client Satisfaction", icon: Shield },
    { value: "500+", label: "Luxury Properties Sold", icon: Zap },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Experience unparalleled service with Beverly Hills' premier luxury real estate expert. 
                Let Amanda Foster guide you to your perfect property investment.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Free Market Analysis</h3>
              <p className="text-sm text-muted-foreground">
                Complimentary property valuation and market insights
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Trusted & Proven</h3>
              <p className="text-sm text-muted-foreground">
                Award-winning service with verified client testimonials
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">White-Glove Service</h3>
              <p className="text-sm text-muted-foreground">
                Personalized luxury experience from start to finish
              </p>
            </div>
          </div>
        </div>
